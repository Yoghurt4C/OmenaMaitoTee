...
public interface TeaMakerInventory extends Inventory {
    DefaultedList<ItemStack> getItems();

    static TeaMakerInventory of(DefaultedList<ItemStack> items) { return () -> items; }

    static TeaMakerInventory ofSize(int size) { return of(DefaultedList.ofSize(size, ItemStack.EMPTY)); }
